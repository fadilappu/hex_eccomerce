      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              Color.fromARGB(255, 65, 73, 80),
              Color.fromARGB(255, 237, 243, 246)
            ],
                              ...
                              child: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  minimumSize: MaterialStateProperty.all(Size(
                                      250,
                                      40)), // Set the desired size of the button
